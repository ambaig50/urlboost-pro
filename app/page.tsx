...
export default function URLBoostPro() {
  ...
  const downloadSubmissionReport = () => {
    ...
    // Header
    doc.setFillColor(30,41,59); doc.rect(0,0,W,42,'F');
    doc.setFillColor(96,165,250); doc.rect(0,0,4,42,'F');
    doc.setTextColor(255,255,255); doc.setFontSize(17);
    doc.text('URLBoost Pro', 14, 14);
    doc.setFontSize(8.5); doc.setTextColor(148,163,184);
    doc.text('Directory Submission Report', 14, 22);
    doc.text(`Website: ${hostname}`, 14, 30);
  ...
  const downloadFullAudit = () => {
    ...
    doc.setFillColor(...sRgb); doc.rect(0,0,5,46,'F');
    doc.setTextColor(255,255,255); doc.setFontSize(18);
    doc.text('URLBoost Pro — Full SEO Audit Report', 14, 14);
    doc.setFontSize(8.5); doc.setTextColor(148,163,184);
    doc.text(`Website: ${hostname}`, 14, 23);
    doc.text(`Analyzed: ${a.url}`, 14, 30);
    doc.text(`Date: ${dateStr}`, 14, 37);
    doc.text(`Powered by PageSpeed Insights + HTML Analysis`, 14, 43);
