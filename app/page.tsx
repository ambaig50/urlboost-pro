      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h1 className="text-2xl font-bold tracking-tight leading-tight">URLBoost Pro</h1>
              <p className="text-amber-600 dark:text-amber-400 text-xs font-semibold">by Ambaig Designs</p>
              <p className="text-slate-400 dark:text-slate-500 text-xs hidden sm:block">SEO Analysis · Submissions · PDF Reports</p>
            </div>
          </div>
          <button
            onClick={() => setDark(d => !d)}
            className="p-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors shadow-sm shrink-0"
