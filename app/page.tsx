...
export default function URLBoostPro() {
  ...
  const downloadReport = () => {
    ...
    // Disclaimer — force onto same page by reducing top margin if needed
    ...
    // If disclaimer + footer won't fit, nudge up slightly — but never add new page
    if (p2y+discH > 282) p2y = 282-discH;
    doc.setFillColor(18,26,40); doc.roundedRect(14,p2y,182,discH,2,2,'F');
    doc.setFontSize(6); doc.setTextColor(80,100,130);
    discLines.forEach((line,i)=>doc.text(line,18,p2y+4+i*4));
